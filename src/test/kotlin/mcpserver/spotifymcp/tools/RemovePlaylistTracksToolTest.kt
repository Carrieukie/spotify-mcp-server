...
class RemovePlaylistTracksToolTest {
     ...
     */
    @Test
    fun `addSpotifyRemovePlaylistTracksTool should not throw exceptions`() {
        // Arrange
        ...
        addSpotifyRemovePlaylistTracksTool(server, playlistService)
